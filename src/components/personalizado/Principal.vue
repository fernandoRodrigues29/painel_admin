                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Total Itens</span>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Pereciveis</span>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Balanço</span>
                ...
                <div class="col-md-6 col-lg-4 order-1 mb-4">
                  ...
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="card-title m-0 me-2">Eventos</h5>
                      <div class="dropdown">
                        <button
                          class="btn p-0"
                          type="button"
...
//menu
import Menu from '@/components/personalizado/Menu.vue';
//graficos
import GraficoBarra from '@/components/GraficoBarra.vue'
import GraficoFunil from '@/components/GraficoFunil.vue'
import GraficoCirculo from '@/components/GraficoSemiCirculo.vue'
...
// import "@/assets/assets/vendor/js/config.js";
...
// import "@/assets/assets/js/dashboards-analytics.js";
